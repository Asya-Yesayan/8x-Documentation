...
Այս գործիքի միջոցով հնարավոր է 8x տեղափոխել վերևում նշված համակարգային նկարագրությունների միայն նկարագրական հատվածը՝ `Definition`, սկրիպտային կտորի տեղափոխումը ավտոմատացված չէ, անհրաժեշտ է կատարել ինքնուրույն։
