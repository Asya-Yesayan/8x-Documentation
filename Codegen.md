...
## Նախապատրաստական քայլեր
 ...
 - Այն պրոյեկտում, որտեղ կիրառվելու է Codegen-ը,անհրաժեշտ է ավելացնել CodeGen.xml անունով ֆայլ՝ գրելով xml-ի version-ը, կոդավորման տեսակը և  տեղափոխվող սկրիպտերի թղթապանակի ճանապարհը։
...
```
- Codegen-ը աշխատում է .tt ընդլայնմամբ ֆայլերի միջոցով։ Codegen-ի աշխատանքի արդյունքում գեներացվում է .cs ընդլայնմամբ ֆայլ։


## Նկարագրությունը տեղափոխելու համար անհրաժեշտ ընդհանուր քայլեր

 - Ստեղծել .tt ընդլայնմամբ ֆայլ։ Դա կարելի է անել հետևյալ ձևով՝ Add -> New Item -> Text Template։ Նախընտրելի  է ֆայլի անունը դնել հետևյալ ֆորմատի՝ GeneratedDSClassName.Codegen.tt, որպեսզի պարզ դառնա որ այն գեներացվել է CodeGen գործիքով։
 - .tt ընդլայնմամբ ֆայլի հետ միասին ստեղծվող նույն անունով .txt ընդլայնմամբ ֆայլը հեռացնել։
...
Տվյալների աղբյուրի նկարագրությունը պարունակող c# դասը գեներացնելու համար անհրաժեշտ է վերևում նշված ընդհանուր քայլերից հետո ավելացնել տվյալների աղբյուրի 4x-ական նկարագրությունը 8x-ականի parse անող մեթոդը կանչը՝ փոխանցելով անհրաժեշտ արգումենտները ու մեթոդի արդյունքը փոխանցել code անունով string տիպի փոփոխականի։
...
Փաստաթղթի սերվիսային նկարագրությունը պարունակող c# դասը գեներացնելու համար անհրաժեշտ է վերևում նշված ընդհանուր քայլերից հետո ավելացնել փաստաթղթի  4x-ական նկարագրությունը 8x-ականի parse անող մեթոդը կանչը՝ փոխանցելով անհրաժեշտ արգումենտները ու մեթոդի արդյունքը փոխանցել code անունով string տիպի փոփոխականի։
...
Փաստաթղթի կլիենտական նկարագրությունը պարունակող c# դասը գեներացնելու համար անհրաժեշտ է վերևում նշված ընդհանուր քայլերից հետո ավելացնել փաստաթղթի 4x-ական նկարագրությունը 8x-ական parse անող մեթոդը կանչը՝ փոխանցելով անհրաժեշտ արգումենտները ու մեթոդի արդյունքը փոխանցել code անունով string տիպի փոփոխականի։
...
.as ֆայլում գնտվող բոլոր փաստաթղթերի կլիենտական նկարագրությունների  c#-ական դասերը գեներացնելու համար անհրաժեշտ է վերևում նշված ընդհանուր քայլերից հետո ավելացնել փաստաթղթի 4x-ական տվյալները 8x-ական parse անող մեթոդը կանչը՝ փոխանցելով անհրաժեշտ արգումենտները ու մեթոդի արդյունքը փոխանցել code անունով string տիպի փոփոխականի։
