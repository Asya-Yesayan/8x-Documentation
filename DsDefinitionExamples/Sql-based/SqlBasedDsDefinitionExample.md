...
- Հետո անհրաժեշտ է սխեմայում ավելացնել տվյալների աղբյուրի սյուների նկարագրությունները։ Դա արվում է Schema դասի `AddColumn` մեթոդի միջոցով, որը ունի հետևյալ կառուցվածքը՝
```c#
